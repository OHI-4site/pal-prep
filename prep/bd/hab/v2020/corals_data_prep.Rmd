...
Try alternative method for calculating scores. Find the number of data points that fall within or above the reference point category and divide by the total number of data points for each zone type.  

```{r calc-status-alt, eval=F}
zones <- read_csv(file.path(dir_goal, "int/coral_zones.csv"))
