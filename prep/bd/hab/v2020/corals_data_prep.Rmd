...
zones_og <- ggplot() + 
  ...
  labs(fill = "Coral Reef Zones") +
  ggtitle("Raw Data Coral Reef Zones")
...
zones_reclass <- ggplot() + 
  ...
  theme(legend.position = "bottom",
        ...
        legend.box.background = element_blank()) +
  labs(fill = "Coral Reef Zones") +
  ggtitle("Reclassified Coral Reef Zones")
...
cover_og <- ggplot() + 
  ...
  theme(legend.position = "bottom",
        ...
        legend.background = element_blank(),
        legend.box.background = element_blank()) +
  labs(fill = "Live Coral Cover Percent") +
  ggtitle("Raw Data Live Coral Cover Percent")
...
cover_reclass <- ggplot() + 
  ...
  theme(legend.position = "bottom",
        ...
        legend.box.background = element_blank()) +
  labs(fill = "Live Coral Cover Percent") +
  ggtitle("Reclassified Live Coral Cover Percent")
