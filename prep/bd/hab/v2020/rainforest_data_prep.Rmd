...
Find the extent (km^2^) of native rainforest habitat. This extent is used in creating weights for pressures and resiliences.  

```{r rainforest-hab-extent, eval=F}
# Use 2019 vegetation area data:
veg_area <- read_csv(file.path(dir_goal, "int/veg_area.csv"))

# Create extent data frame 
rainforest_extent <- data.frame(
  region_id = 1, 
  habitat = "rainforest",
  year = 2019,
  km2 = veg_area$cover_area[veg_area$category=="forest"]
)
