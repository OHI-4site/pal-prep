...
A 0-1 score is assigned to each species based on IUCN conservation status:   
 
  * 'LC' = 0, 'NT' = 0.2, 'CD' = 0.3, 'VU' = 0.4, 'T' = 0.6, 'EN' = 0.6, 'CR' = 0.8, 'EX' = 1.0  

The status is first calculated for each class by averaging the category scores. The overall status is then the average of the status score for each class.  
