...
None of the 104 remaining species had common names in taxize

Some exploration of the missing species:  
...
```{r save, eval = F}
# save
write_csv(iucn_spp_info, file.path(dir_github, 'prep/bd/spp/v2020/int/1_iucn_spp_in_pal.csv'))
```
