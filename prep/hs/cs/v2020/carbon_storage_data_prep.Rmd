...
The following tree species are included in the mapping project and we have designated if they are native or nonnative. Native status was assigned based on the Palmyra Native Plants list, found [here](http://www.hawaii.edu/gk-12/palmyra/specieslist/nativeplants.htm), and the U.S. Department of Agriculture [Plants Database](https://plants.sc.egov.usda.gov/java/). Species listed with Native (N) for the Pacific Basin (PB) are assigned a native status. Primary nonnative species were identified though the U.S. Geological Survey 2010 Biological Security Plan for Palmyra Atoll, found [here](https://pubs.usgs.gov/of/2010/1097/pdf/of20101097.pdf).         

 - *Araucaria*, species unknown: Native   
...
natives <- c("Araucaria", "Barringtonia asiatica", "Cordia subcordata", "Guettarda speciosa",
             "Heliotropium foertherianum", "Hernandia nymphaeifolia", "Ipomoea", "Nephrolepis",
