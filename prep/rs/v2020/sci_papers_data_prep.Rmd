...
This script calculates the status of scientific research conducted on Palmyra as part of the Research goal.      
...
The reference point for publications is 10 scientific publications per year. The scientific papers layer is calculated as the following:   
