---
title: 'OHI+ Palmyra 2020: Habitat Destruction Pressure'
...
dir_prs   <- '~/github/pal-prep/prep/pressures/habitat/v2020'
```
...
write_csv(hd_pressure, file.path(dir_scores, "layers/hd_pressure.csv"))
```
