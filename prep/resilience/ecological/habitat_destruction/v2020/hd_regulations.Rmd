---
title: 'OHI+ Palmyra 2020: Habitat Regulations Resilience Layer'
...
Regulatory resilience is meant to describes the institutional measures (e.g., rules, regulations, and laws) designed to address ecological pressures. This script calculates resilience from regulations protecting marine and terrestrial habitats on Palmyra Atoll.   
...
dir_res   <- '~/github/pal-prep/prep/resilience/ecological/habitat_destruction/v2020'
dir_lsp   <- '~/github/pal-prep/prep/sp/lsp/v2020'
dir_fp    <-  '~/github/pal-prep/prep/resilience/ecological/fishing_pressure/v2020'
```
